<div class="flex h-screen bg-gray-100" x-data="{}">
    ...
    <div class="w-80 bg-white shadow-lg flex flex-col p-5 gap-4 overflow-y-auto">
        ...
        <div>
            ...
            <div class="grid grid-cols-3 gap-2">
                ...
                <label class="flex items-center justify-center gap-1 cursor-pointer border rounded-lg px-2 py-2 text-xs font-medium
    ...
    document.addEventListener('DOMContentLoaded', () => {
        Livewire.on('transaction-success', (event) => {
            let transactionId = event[0].transactionId ?? event.transactionId ?? event[0];
            window.open('/kasir/transaction/' + transactionId + '/struk', '_blank');
        });
    });
</script>
